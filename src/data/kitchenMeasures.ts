...
export const ingredientMeasures: IngredientMeasure[] = [
  ...
  { name: "Масло растит.",  tablespoon: 17, teaspoon: 6, glass: 230, pinch: 0 },
  { name: "Масло сливочное",tablespoon: 20, teaspoon: 7, glass: 210, pinch: 0 },
  ...
  { name: "Молоко",         tablespoon: 18, teaspoon: 6, glass: 250, pinch: 0 },
  { name: "Вода",           tablespoon: 18, teaspoon: 6, glass: 250, pinch: 0 },
];
